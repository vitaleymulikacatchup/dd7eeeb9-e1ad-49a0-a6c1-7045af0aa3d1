...
export const metadata: Metadata = {
  title: "Grand Azure Hotel - Luxury 5-Star Accommodations",
  description: "Experience unparalleled luxury at Grand Azure Hotel. Premium rooms, world-class amenities, fine dining, and exceptional service in a stunning oceanfront setting.",
  keywords: "luxury hotel, 5-star accommodation, oceanfront hotel, spa resort, fine dining, premium suites, business hotel, vacation resort",
  openGraph: {
    title: "Grand Azure Hotel - Luxury 5-Star Accommodations",
    description: "Experience unparalleled luxury at Grand Azure Hotel with premium accommodations and world-class amenities.",
